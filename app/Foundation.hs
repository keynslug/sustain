...
import Data.Text (breakOn, stripPrefix, append)
import Data.Text.Lazy (toStrict)
import Text.Jasmine (minifym)
import Text.Blaze.Renderer.Text (renderMarkup)
import LDAP (LDAPScope(..))
...
instance Yesod Sustain where
    ...
    defaultLayout contents = do
        ...
        withUrlRenderer $(hamletFile "app/template/layout.hamlet")
...
instance YesodAuth Sustain where
    ...
    authPlugins master = [ genericAuthLDAP LDAPConfig {
        usernameFilter = append "sAMAccountName=",
